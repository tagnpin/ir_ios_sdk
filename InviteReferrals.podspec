...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of InviteReferrals.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ashraf-nv/InviteReferrals'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ashraf-nv' => 'ashraf@notifyvisitors.com' }
  s.source           = { :git => 'https://github.com/ashraf-nv/InviteReferrals.git', :tag => s.version.to_s }
